# Generated by Django 4.1.2 on 2022-10-07 15:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kich_co', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Shoes.kichco')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('danh_muc', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='Shoes.danhmuc')),
                ('kich_co', models.ManyToManyField(through='Shoes.KichCoSanPham', to='Shoes.kichco')),
            ],
            options={
                'db_table': 'SanPham',
            },
        ...
        migrations.AddField(
            model_name='kichcosanpham',
            name='san_pham',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Shoes.sanpham'),
        ),
    ]
